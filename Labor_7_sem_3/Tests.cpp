...
TEST_CASE("Test TemplateList class 1")
{
	int a = 10;
	int b = 5;
	int c = 5;
	...
	TList<int> Name_list(a);
	Name_list.add_node(b);
	Name_list.add_node(c);
	Name_list.add_node(d);
	Name_list.add_node(e);



	printf("%s", Name_list.to_string());
	cout << "===============================================================================\n";
	printf("%s", Name_list.find_by_number(5));
	cout << "===============================================================================\n";
	...
	TList<float> Name_list1(a1);
	Name_list1.add_node(b1);
	Name_list1.add_node(c1);
	Name_list1.add_node(d1);
	Name_list1.add_node(e1);


	printf("%s", Name_list1.to_string());
}
